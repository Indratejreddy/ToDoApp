...
import deleteAToDo from "../utils/DeleteAToDo";
    ...
    <>
      <div className="flex flex-col justify-center items-center w-full m-4">
        <div className="flex w-full justify-between items-center group">
          ...
          <div className="invisible group-hover:visible flex justify-between items-center gap-3  flex-wrap">
            <button
              className={
              ...
              onClick={() => {
                updateStatus(toDoStatusUrl, toDoStatus, setToDos);
              }}
            >
              <svg
            ...
            <button className="group bg-[#f4f4f4] p-1 rounded-2xl flex justify-center hover:border-orange-600 border-2 shadow-3xl">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <Link to="/home">
              <button
                onClick={() => deleteAToDo(toDoId, setToDos)}
